    ...
    <div className="relative min-h-screen bg-background flex flex-col items-center overflow-hidden">
      ...
      <header className="w-full max-w-7xl mx-auto p-6 flex justify-between items-center z-50">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <Link href="/demo">
            <Button
              variant="ghost"
              className="rounded-full font-semibold text-muted-foreground hover:text-foreground text-sm md:text-base px-2 md:px-4"
            >
              Try Demo
            </Button>
          </Link>
          ...
          <Link href="/login">
            <Button className="rounded-full px-4 md:px-6 font-bold shadow-lg shadow-primary/20 text-sm md:text-base">
              Get Started
            </Button>
          </Link>
        </div>
      ...
      <main className="flex flex-col items-center w-full max-w-7xl px-6 pt-20 pb-32">
        ...
        >
          <motion.div
            variants={fadeInUp}
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-border bg-muted/30 text-xs font-semibold uppercase tracking-wider mb-8 text-muted-foreground"
          >
          ...
          <motion.h1
            variants={fadeInUp}
            className="text-4xl md:text-6xl lg:text-8xl font-black tracking-tighter leading-[0.9] text-foreground mb-8"
          >
            Your{" "}
            <span
